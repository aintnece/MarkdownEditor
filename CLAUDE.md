...
- **Obsidian vault**: `/data/Online Document/obsidian-vault/鸿蒙开发/` — API refs, guides, 踩坑记录
- **Project state**: `.project/status.md` — current completion (relative to project root)
- **Active task**: `.project/active-task.md` — what to work on next
- **Decisions**: `.project/decisions/` — design rationale
